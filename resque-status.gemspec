...
# -*- encoding: utf-8 -*-
# stub: resque-status 0.5.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Aaron Quint".freeze, "Cinti Puddu".freeze]
  s.date = "2020-10-05"
  ...
  s.email = "developers@livelinktechnology.net".freeze
  s.extra_rdoc_files = [
    "LICENSE",
    "README.rdoc"
  ]
  ...
  s.homepage = "http://github.com/livelink/resque-status".freeze
